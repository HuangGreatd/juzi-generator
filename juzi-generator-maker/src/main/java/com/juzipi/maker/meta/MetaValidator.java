...
import com.juzipi.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    public static void doVaildAndFill(Meta meta) {
    ...
    private static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "juzipi");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.juzipi");
